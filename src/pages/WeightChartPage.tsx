...
export function WeightChartPage() {
  ...
  const filteredReadings = useMemo(() => hasInvalidRange ? [] : applyReadingFilters(weightReadings, filters), [filters, hasInvalidRange, weightReadings]);
    ...
    <SiteShell title="Weight Trends" subtitle="Chart view with optional filters below.">
      ...
      <section className="doc-card section-stack compact-controls">
        <details className="compact-details">
          ...
          <TagChipSelector tags={weightTags} readings={weightReadings} settings={settings} selectedTagIds={filters.tagIds} onChange={(tagIds) => setFilters((c) => ({ ...c, tagIds }))} manageLinkTo="/settings/tags" />
        </details>
      </section>
